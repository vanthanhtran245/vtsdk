...
public extension UIAlertController {
	...
	/// SunflowerExtension: Present alert view controller in the current view controller.
	///
	/// - Parameters:
	...
	/// SunflowerExtension: Add an action to Alert
	///
	/// - Parameters:
	///   - title: action title
	...
	/// SunflowerExtension: Add a text field to Alert
	///
	/// - Parameters:
...
public extension UIAlertController {
	...
	/// SunflowerExtension: Create new alert view controller with default OK action.
	///
	/// - Parameters:
	...
	/// SunflowerExtension: Create new error alert view controller from Error with default OK action.
	///
	/// - Parameters:
	...
	///   - defaultActionButtonTitle: default action button title (default is "OK")
	///   - tintColor: alert controller's tint color (default is nil)
    public convenience init(title: String = "Error", error: Error, defaultActionButtonTitle: String = "OK", preferredStyle: Style = .alert, tintColor: UIColor? = nil) {

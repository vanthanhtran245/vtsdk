...
extension UIEdgeInsets {
    /// SunflowerExtension: Return the vertical insets. The vertical insets is composed by top + bottom.
    ///
    ...
    /// SunflowerExtension: Return the horizontal insets. The horizontal insets is composed by  left + right.
    ///
...
// MARK: - Methods
extension UIEdgeInsets {
    /// SunflowerExtension: Creates an `UIEdgeInsets` with the inset value applied to all (top, bottom, right, left)
    ///
    ...
    /// SunflowerExtension: Creates an `UIEdgeInsets` with the horizontal value equally divided and applied to right and left.

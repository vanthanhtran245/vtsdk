...
//  SunflowerExtension
//
//  Created by Thanh Tran Van on 11/12/2016.
...
public extension UICollectionView {
	...
	/// SunflowerExtension: Index path of last item in collectionView.
	public var indexPathForLastItem: IndexPath? {
		return indexPathForLastItem(inSection: lastSection)
	}

	/// SunflowerExtension: Index of last section in collectionView.
...
public extension UICollectionView {
	...
	/// SunflowerExtension: Number of all items in all sections of collectionView.
	///
	...
	/// SunflowerExtension: IndexPath for last item in section.
	///
	...
	/// SunflowerExtension: Reload data with a completion handler.
	///
	...
	/// SunflowerExtension: Dequeue reusable UICollectionViewCell using class name.
	///
	/// - Parameters:
	...
	/// SunflowerExtension: Dequeue reusable UICollectionReusableView using class name.
	///
	/// - Parameters:
	...
	/// SunflowerExtension: Register UICollectionReusableView using class name.
	///
	/// - Parameters:
	///   - kind: the kind of supplementary view to retrieve. This value is defined by the layout object.
	///   - name: UICollectionReusableView type.
	...
	/// SunflowerExtension: Register UICollectionViewCell using class name.
	///
	/// - Parameters:
    ...
    /// SunflowerExtension: Register UICollectionViewCell with .xib file using only its corresponding class.

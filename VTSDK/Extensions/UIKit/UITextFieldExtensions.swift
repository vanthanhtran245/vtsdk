...
public extension UITextField {
	...
	/// SunflowerExtension: UITextField text type.
	///
...
public extension UITextField {
	...
	/// SunflowerExtension: Set textField for common text types.
	...
	/// SunflowerExtension: Check if text field is empty.
	public var isEmpty: Bool {
		return text?.isEmpty == true
	}

	/// SunflowerExtension: Return text with no spaces or new lines in beginning and end.
	public var trimmedText: String? {
		return text?.trimmingCharacters(in: .whitespacesAndNewlines)
	}

	/// SunflowerExtension: Check if textFields text is a valid email format.
	///
	///		textField.text = "john@doe.com"
	///		textField.hasValidEmail -> true
	///
	///		textField.text = "SunflowerExtension"
	...
	/// SunflowerExtension: Left view tint color.
	...
	/// SunflowerExtension: Right view tint color.
...
public extension UITextField {
	...
	/// SunflowerExtension: Set placeholder text color.
	///
	...
	/// SunflowerExtension: Add padding to the left of the textfield rect.
	///

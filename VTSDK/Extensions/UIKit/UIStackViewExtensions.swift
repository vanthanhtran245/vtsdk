...
public extension UIStackView {
    ...
    /// SunflowerExtension: Initialize an UIStackView with an array of UIView and common parameters.
    ///
    ...
    public convenience init(arrangedSubviews: [UIView], axis: NSLayoutConstraint.Axis, spacing: CGFloat = 0.0, alignment: Alignment = .fill, distribution: Distribution = .fill) {
	...
	/// SunflowerExtension: Adds array of views to the end of the arrangedSubviews array.
	///
	...
	/// SunflowerExtension: Removes all views in stack’s array of arranged subviews.

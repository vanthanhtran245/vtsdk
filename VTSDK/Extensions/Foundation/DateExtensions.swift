...
//  SunflowerExtension
//
//  Created by Thanh Tran Van on 8/5/18.
...
public extension Date {
	...
	/// SunflowerExtension: Day name format.
	///
	...
	/// SunflowerExtension: Month name format.
	///
...
public extension Date {
	...
	/// SunflowerExtension: User’s current calendar.
	public var calendar: Calendar {
		return Calendar.current
	}

	/// SunflowerExtension: Era.
	///
	///		Date().era -> 1
	///
	public var era: Int {
	...
	/// SunflowerExtension: Week of year.
	///
	...
	/// SunflowerExtension: Week of month.
	///
	...
	/// SunflowerExtension: Nanoseconds.
	///
	...
	/// SunflowerExtension: Milliseconds.
	///
	/// 	Date().millisecond -> 68
	///
	/// 	var someDate = Date()
	...
	/// SunflowerExtension: Check if date is in future.
	///
	...
	/// SunflowerExtension: Check if date is in past.
	///
	...
	/// SunflowerExtension: Check if date is within today.
	///
	/// 	Date().isInToday -> true
	///
	...
	/// SunflowerExtension: Check if date is within yesterday.
	///
	...
	/// SunflowerExtension: Check if date is within tomorrow.
	///
	...
	/// SunflowerExtension: Check if date is within a weekend period.
	public var isInWeekend: Bool {
		return Calendar.current.isDateInWeekend(self)
	}

	/// SunflowerExtension: Check if date is within a weekday period.
	public var isWorkday: Bool {
		return !Calendar.current.isDateInWeekend(self)
	}

	/// SunflowerExtension: Check if date is within the current week.
	public var isInCurrentWeek: Bool {
		return Calendar.current.isDate(self, equalTo: Date(), toGranularity: .weekOfYear)
	}

	/// SunflowerExtension: Check if date is within the current month.
	public var isInCurrentMonth: Bool {
		return Calendar.current.isDate(self, equalTo: Date(), toGranularity: .month)
	}

	/// SunflowerExtension: Check if date is within the current year.
	public var isInCurrentYear: Bool {
		return Calendar.current.isDate(self, equalTo: Date(), toGranularity: .year)
	}

	/// SunflowerExtension: ISO8601 string of format (yyyy-MM-dd'T'HH:mm:ss.SSS) from date.
	///
	...
	/// SunflowerExtension: Nearest five minutes to date.
	///
	...
	/// SunflowerExtension: Nearest ten minutes to date.
	///
	...
	/// SunflowerExtension: Nearest quarter hour to date.
	///
	/// 	var date = Date() // "5:57 PM"
	/// 	date.minute = 34 // "5:34 PM"
	...
	/// SunflowerExtension: Nearest half hour to date.
	///
	...
	/// SunflowerExtension: Nearest hour to date.
	///
	...
	/// SunflowerExtension: Time zone used currently by system.
	///
	...
	/// SunflowerExtension: UNIX timestamp from date.
	///
...
public extension Date {
	...
	/// SunflowerExtension: Date by adding multiples of calendar component.
	///
	...
	/// SunflowerExtension: Add calendar component to date.
	///
	...
	/// SunflowerExtension: Date by changing value of calendar component.
	///
	/// 	let date = Date() // "Jan 12, 2017, 7:07 PM"
	...
	/// SunflowerExtension: Data at the beginning of calendar component.
	///
	...
	/// SunflowerExtension: Date at the end of calendar component.
	///
	...
	/// SunflowerExtension: Check if date is in current given calendar component.
	///
	...
	/// SunflowerExtension: Date string from date.
	///
	...
	/// SunflowerExtension: Date and time string from date.
	///
	...
	/// SunflowerExtension: Time string from date
	///
	...
	/// SunflowerExtension: Day name from date.
	///
	...
	/// SunflowerExtension: Month name from date.
	///
	...
	/// SunflowerExtension: get number of seconds between two date
	///
	...
	/// SunflowerExtension: get number of minutes between two date
	///
	/// - Parameter date: date to compate self to.
	...
	/// SunflowerExtension: get number of hours between two date
	///
	/// - Parameter date: date to compate self to.
	...
	/// SunflowerExtension: get number of days between two date
	///
	/// - Parameter date: date to compate self to.
	...
	/// SunflowerExtension: check if a date is between two other dates
	///
	/// - Parameters:
	...
	/// SunflowerExtension: check if a date is a number of date components of another date
	///
	/// - Parameters:
	...
	/// SunflowerExtension: Random date between two dates.
	///
	///     Date.random()
...
public extension Date {
	...
	/// SunflowerExtension: Create a new date form calendar components.
	///
	...
	/// SunflowerExtension: Create date object from ISO8601 string.
	///
	...
	/// SunflowerExtension: Create new date object from UNIX timestamp.
	///
	...
	/// SunflowerExtension: Create date object from Int literal
	///

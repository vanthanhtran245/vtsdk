...
public extension UserDefaults {
	...
	/// SunflowerExtension: get object from UserDefaults by using subscript
	///
	...
	/// SunflowerExtension: Float from UserDefaults.
	///
	...
	/// SunflowerExtension: Date from UserDefaults.
	///
	...
	/// SunflowerExtension: Retrieves a Codable object from UserDefaults.
	///
	/// - Parameters:
	...
	/// SunflowerExtension: Allows storing of Codable objects to UserDefaults.
	///
	/// - Parameters:

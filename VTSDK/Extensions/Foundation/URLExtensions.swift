...
//  SunflowerExtension
//
//  Created by Thanh Tran Van on 03/02/2017.
...
public extension URL {
	...
	/// SunflowerExtension: Dictionary of the URL's query parameters
...
public extension URL {
	...
	/// SunflowerExtension: URL with appending query parameters.
	///
	...
	/// SunflowerExtension: Append query parameters to URL.
	///
    ...
    /// SunflowerExtension: Get value of a query key.
    ///
    ...
    /// SunflowerExtension: Returns a new URL by removing all the path components.
    ///
    ...
    /// SunflowerExtension: Remove all the path components from the URL.
    ///

...
public extension Collection {
	...
	/// SunflowerExtension: Performs `each` closure for each element of collection in parallel.
	///
	...
	/// SunflowerExtension: Safe protects the array from out of bounds by use of optional.
	///
	///		let arr = [1, 2, 3, 4, 5]
	///		arr[safe: 1] -> 2
	///		arr[safe: 10] -> nil
...
public extension Collection where Index == Int {
	...
	/// SunflowerExtension: Random item from array.
    ...
    /// SunflowerExtension: Get the first index where condition is met.
    ///
    ...
    /// SunflowerExtension: Get the last index where condition is met.
    ///
    ...
    /// SunflowerExtension: Get all indices where condition is met.
    ///
    ...
    /// SunflowerExtension: Calls the given closure with an array of size of the parameter slice.
    ///
    ...
    /// SunflowerExtension: Returns an array of slices of length "size" from the array. If array can't be split evenly, the final slice will be the remaining elements.
    ///
...
public extension Collection where Element: Equatable, Index == Int {
    ...
    /// SunflowerExtension: First index of a given item in an array.
    ///
    ...
    /// SunflowerExtension: Last index of element in array.
    ///
...
public extension Collection where Element == IntegerLiteralType, Index == Int {
	...
	/// SunflowerExtension: Average of all elements in array.
	///

...
public extension Array {
	...
	/// SunflowerExtension: Insert an element at the beginning of array.
	///
	...
	/// SunflowerExtension: Safely Swap values at index positions.
	///
	...
	/// SunflowerExtension: Keep elements of Array while condition is true.
	///
	...
	/// SunflowerExtension: Take element of Array while condition is true.
	///
	...
	/// SunflowerExtension: Skip elements of Array while condition is true.
	///
	...
	/// SunflowerExtension: Separates an array into 2 arrays based on a predicate.
	///
	...
	/// SunflowerExtension: Returns a new rotated array by the given places.
	///
	...
	/// SunflowerExtension: Rotate the array by the given places.
	///
	...
	/// SunflowerExtension: Shuffle array. (Using Fisher-Yates Algorithm)
	///
	...
	/// SunflowerExtension: Shuffled version of array. (Using Fisher-Yates Algorithm)
	///
	...
	/// SunflowerExtension: Returns a sorted array based on an optional keypath.
	///
	...
	/// SunflowerExtension: Returns a sorted array based on a keypath.
	///
	/// - Parameter path: Key path to sort. The key path type must be Comparable.
	/// - Parameter ascending: If order must be ascending.
	/// - Returns: Sorted array based on keyPath.
	...
	/// SunflowerExtension: Sort the array based on an optional keypath.
	///
	/// - Parameters:
	...
	/// SunflowerExtension: Sort the array based on a keypath.
	///
	/// - Parameters:
	///   - path: Key path to sort, must be Comparable.
	///   - ascending: whether order is ascending or not.
    ...
    /// SunflowerExtension: Removes the first element of the collection which satisfies the given predicate.
    ///
...
public extension Array where Element: Equatable {
	...
	/// SunflowerExtension: All indices of specified item.
	///
	...
	/// SunflowerExtension: Remove all instances of an item from array.
	///
	...
	/// SunflowerExtension: Remove all instances contained in items parameter from array.
	///
	...
	/// SunflowerExtension: Remove all duplicate elements from Array.
	///
	...
	/// SunflowerExtension: Return array with all duplicate elements removed.
	///

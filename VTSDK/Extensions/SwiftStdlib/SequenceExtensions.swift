...
public extension Sequence {
    ...
    /// SunflowerExtension: Check if all elements in collection match a conditon.
    ///
    ...
    /// SunflowerExtension: Check if no elements in collection match a conditon.
    ///
    ...
    /// SunflowerExtension: Check if any element in collection match a conditon.
    ///
    ...
    /// SunflowerExtension: Get last element that satisfies a conditon.
    ///
    ...
    /// SunflowerExtension: Filter elements based on a rejection condition.
    ///
    ...
    /// SunflowerExtension: Get element count based on condition.
    ///
    ...
    /// SunflowerExtension: Iterate over a collection in reverse order. (right to left)
    ///
    ...
    /// SunflowerExtension: Calls the given closure with each element where condition is true.
    ///
    ...
    /// SunflowerExtension: Reduces an array while returning each interim combination.
    ///
    ...
    /// SunflowerExtension: Filtered and map in a single operation.
    ///
    ...
    /// SunflowerExtension: Get the only element based on a condition.
    ///
...
public extension Sequence where Element: Equatable {
    ...
    /// SunflowerExtension: Check if array contains an array of elements.
    ///
...
public extension Sequence where Element: Hashable {
    ...
    /// SunflowerExtension: Check whether a sequence contains duplicates.
    ///
...
public extension Sequence where Element: Numeric {
    ...
    /// SunflowerExtension: Sum of all elements in array.
    ///
    ///        [1, 2, 3, 4, 5].sum() -> 15
    ///
